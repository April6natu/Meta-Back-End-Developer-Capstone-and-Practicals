...
coffee = float(input('1 coffee @: $ '))  # ✅ convert to float

# Modify the line below
sandwich = float(input('1 sandwich @: $ '))  # ✅ convert to float

# Modify the line below
cake = float(input('1 cake @: $ '))  # ✅ convert to float

bill_total = coffee + sandwich + cake

print('Your total bill is $', round(bill_total, 2))  # ✅ round to 2 decimal places
